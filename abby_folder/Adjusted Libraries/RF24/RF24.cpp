...
bool RF24::write( const void* buf, uint8_t len, const bool multicast, Header& myHeader)
{
	if(myHeader.to_node==myHeader.from_node){
		Serial.println("You cannot view this message");
	}
	else{
	//Start Writing
...
bool RF24::write( const void* buf, uint8_t len ){
	RF24::Header defaultHeader={0xF0F0F0F0E1LL, 0xF0F0F0F0D2LL};
	return write(buf,len,0,defaultHeader);
}
/****************************************************************************/
